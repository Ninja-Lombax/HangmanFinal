...
public class HangmanGame
{
    ...
    //private String[] words = {"GODZILLA", "WILLINGNESS", "DRAGON", "DINOSAUR", "JAPAN", "CHECKBOOK", "LOMBAX", "CRAYON", "TABLE", "INCLUDE", "SUBSTANCE", "DOLLAR", "BOOKKEEPER", "ISLAND"};
    ...
    public HangmanGame() // Constructor that sets the Hangman game up
    {
        ...
        else // This sets up the two player hangman
        {
            ...
            getPlayerWord = getPlayerWord.toUpperCase();
            guessWord = getPlayerWord.toCharArray(); // Sets the word to a character array

            for(int i = 0; i<5000; i++) // Can't clear screen so moves the word down so the other player cannot see it
           {
              System.out.println(" ");
    ...
    public void wordComparison(char[] userLetter)
    {
        ...
        for (int i = 0; i < displayedWord.length; i++)
        {
            ...
            // If a letter is not found than the displayBody() method is called to display a body part
